...
#endif
{
    ...
    // The current ncnn shader interface no longer defines the legacy pack8
    // arithmetic helpers used by this RIFE port. Keep FP16 storage enabled but
    // force pack1/pack4 paths so shader compilation cannot select pack8.
